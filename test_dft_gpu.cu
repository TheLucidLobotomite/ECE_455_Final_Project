...
int main() {
    ...
    std::cout << "Eigenvalue Solver: GPU (cuSOLVER)\n\n";
 ...
 * 2. Compile and run with SLURM or directly:
 *    
 *    sbatch gpu_dft_slurm.sh
 * 
 * ============================================
